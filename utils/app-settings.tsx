...
const TRANSLATIONS = {
  en: {
    ...
    settingsJournalBackupTitle: 'Canvas backup',
    settingsJournalBackupHint: 'Export entries before changing devices or clearing local data.',
    settingsExportJournalData: 'Export Canvas data',
    settingsResetJournalData: 'Reset Canvas data',
    settingsResetTitle: 'Reset Canvas data?',
    settingsResetMessage:
      'This clears all local Canvas entries, favorites, and verse designs from this device.',
    settingsResetSuccess: 'Canvas entries, favorites, and verse designs were reset.',
    settingsResetError: 'Could not reset Canvas data.',
    ...
    settingsExportDownloaded: 'Canvas backup downloaded.',
    settingsExportReady: 'Canvas backup is ready to save or share.',
    ...
    studioDiscardNewPageMessage:
      'Starts a blank Canvas page. Unsaved changes on this page will be lost. Anything already saved stays in your Canvas pages.',
    studioDiscardConfirm: 'Discard',
    studioPagesTitle: 'Canvas pages',
    studioPagesEmpty: 'No Canvas pages yet. Save a page to see it here.',
    studioPagesCurrent: 'Current',
    studioPagesNewPage: 'New page',
    studioOpenPagesAccessibility: 'Open Canvas pages',
    ...
    verseDesignsEmptyText: 'Create a verse in Canvas and it will show up here.',
    ...
    homeActionJournal: 'Write about it',
    homeActionChurchDay: 'Church Day notes',
    homeOpenInStudio: 'Open in Canvas',
    homeReflect: 'Reflect',
    ...
    favoritesEmptyText: 'Save a Canvas verse design and it will appear here.',
    ...
    shopSubtitle: 'Creative supplies for Canvas and journals',
    ...
    shopIncludedNote: 'This pack is ready to use in Canvas and journal decoration tools.',
    ...
    shopPurchaseSuccess: 'Pack unlocked. It is ready to use in Canvas and journals.',
    ...
    shopPreviewLocalShelf: 'This preview is in your local shelf. Its tools still need to be built before it appears in Canvas.',
    ...
    bibleReaderVerseSubtitle:
      'Scroll to read. Tap Canvas on any verse when you want to make something with it.',
    bibleSendToStudioAccessibility: 'Send {{reference}} to Canvas',
    ...
    editorEntryTitle: 'Title',
    editorEntryTitlePlaceholder: 'Entry title',
    editorDecorateVerseInStudio: 'Decorate this verse in Canvas',
    editorLock: 'Lock',
    editorUnlock: 'Unlock',
    editorUnlockStudio: 'Unlock Canvas',
    editorLockStudio: 'Lock Canvas',
  ...
  es: {
    ...
    settingsJournalBackupTitle: 'Respaldo de Canvas',
    settingsJournalBackupHint:
      'Exporta tus entradas antes de cambiar de dispositivo o borrar datos locales.',
    settingsExportJournalData: 'Exportar datos de Canvas',
    settingsResetJournalData: 'Restablecer datos de Canvas',
    settingsResetTitle: '¿Restablecer datos de Canvas?',
    settingsResetMessage:
    ...
    settingsResetError: 'No se pudieron restablecer los datos de Canvas.',
    ...
    settingsExportDownloaded: 'Respaldo de Canvas descargado.',
    settingsExportReady: 'El respaldo de Canvas está listo para guardar o compartir.',
    settingsExportError: 'No se pudo preparar el respaldo de Canvas.',
    settingsSyncErrorUsernamePhraseMismatch:
    ...
    studioDiscardNewPageMessage:
      'Abre una página en blanco de Canvas. Se perderán los cambios no guardados de esta página. Lo que ya esté guardado en tus páginas de Canvas se queda.',
    studioDiscardConfirm: 'Descartar',
    studioPagesTitle: 'Páginas de Canvas',
    studioPagesEmpty: 'Aún no hay páginas de Canvas. Guarda una para verla aquí.',
    studioPagesCurrent: 'Actual',
    studioPagesNewPage: 'Nueva página',
    studioOpenPagesAccessibility: 'Abrir páginas de Canvas',
    ...
    verseDesignsEmptyText: 'Crea un versículo en Canvas y aparecerá aquí.',
    ...
    homeOpenInStudio: 'Abrir en Canvas',
    ...
    favoritesEmptyText: 'Guarda un diseño de Canvas y aparecerá aquí.',
    ...
    shopSubtitle: 'Recursos creativos para Canvas y diarios',
    ...
    shopIncludedNote: 'Este paquete está listo para usar en Canvas y en herramientas del diario.',
    ...
    shopUseInStudio: 'Usar en Canvas',
    ...
    shopPurchaseSuccess: 'Paquete desbloqueado. Ya está listo para usar en Canvas y diarios.',
    ...
    shopPreviewLocalShelf: 'Esta vista previa está en tu colección local. Sus herramientas aún deben construirse antes de aparecer en Canvas.',
    ...
    bibleReaderVerseSubtitle:
      'Desplázate para leer. Toca Canvas en cualquier versículo cuando quieras crear algo.',
    bibleSendToStudioAccessibility: 'Enviar {{reference}} a Canvas',
    ...
    editorEntryTitle: 'Título',
    editorEntryTitlePlaceholder: 'Título de la entrada',
    editorDecorateVerseInStudio: 'Decorar este versículo en Canvas',
    editorLock: 'Bloquear',
    editorUnlock: 'Desbloquear',
    editorUnlockStudio: 'Desbloquear Canvas',
    editorLockStudio: 'Bloquear Canvas',
